...
*** text menu *ara-map t*
    Move simple command using keymap with this
    #+begin_src emacs-lisp
      ;; short menu for manipulating/searching/jumping  text
      (defhydra hydra-text-menu (:color red :hint nil)
	"text menu "
	("c l" avy-copy-line "copy line")
	("c r" avy-copy-region "copy region")
	("k l" avy-kill-whole-line "delete line")
	("k r" avy-kill-region "delete region")
	("k L" avy-kill-ring-save-whole-line "kill line")
	("k R" avy-kill-ring-save-region "kill region")
	("g c" avy-goto-char "jump to character")
	("g w" avy-goto-word-0 "jump to word")
	("g l" avy-goto-line "jump to line")
	("r f" elfeed "read feed")
	("r g" elpher "read gemini site")
	("q" nil))

      (define-key ara-map "t" 'hydra-text-menu)
    #+end_src
...
*** windows management *ara-map w*
	...
	("m" headlong-bookmark-jump))
      ...
      (define-key ara-map "w" 'hydra-text-menu)
    #+end_src
